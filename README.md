...
* 3 Input datasets (ADSL, ADAE, ADTTE)
* 6 Modules included (Data Table, Variable Browser, Demographic Table, Disposition Info, Adverse Event Table, EG Shift tables, KM Plot)
